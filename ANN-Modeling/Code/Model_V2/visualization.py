...
class ModelVisualizer:
    ...
    def create_td_vs_asd_comparison_plot(self, explainability_data):
        ...
        ax.set_title('TD vs ASD: Characteristic Mention Patterns - Model V2')
        ax.set_xticks(x)
    ...
    def create_model_performance_plot(self, training_results):
        ...
        ax1.set_title('Cross-Validation Scores - Model V2')
    ...
    def create_feature_importance_by_target_plot(self, explainability_data):
        ...
        ax1.set_title('Top Features: Importance and Target Class Comparison - Model V2')
        ax1.set_xticks(x)
