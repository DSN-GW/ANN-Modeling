...
class ModelVisualizer:
    def __init__(self):
        ...
        self.results_dir = project_root / "Results" / "V3"
    ...
    def create_feature_importance_plot(self, explainability_data):
        ...
        plt.title('Top 20 Most Important Features - XGBoost Model V3')
    ...
    def create_characteristic_importance_plot(self, explainability_data):
        ...
        ax1.set_title('Characteristic Importance Scores - Model V3')
    ...
    def create_td_vs_asd_comparison_plot(self, explainability_data):
        ...
        ax.set_title('TD vs ASD: Characteristic Mention Patterns - Model V3')
        ax.set_xticks(x)
    ...
    def create_model_performance_plot(self, training_results):
        ...
        ax1.set_title('Cross-Validation Scores - Model V3')
    ...
    def create_feature_importance_by_target_plot(self, explainability_data):
        ...
        ax1.set_title('Top Features: Importance and Target Class Comparison - Model V3')
        ax1.set_xticks(x)
